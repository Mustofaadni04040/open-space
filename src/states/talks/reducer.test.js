...
describe('talkReducers function', () => {
  //  menguji hasil pemanggilan fungsi talkReducer()dengan action yang tidak dikenal.
  ...
  it('should return the talks with the toggled like when given by TOGGLE_LIKE_TALK action', () => {
    // arrange
    const initialState = [
      {
        id: 'talk-1',
